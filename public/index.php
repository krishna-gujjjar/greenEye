...
<div class="greeneye-gallery-area owl-carousel">
    ...
    <div class="single-gallery-item">
        ...
        <div class="view-more-btn">
            <a href="<?php echo ASSETS; ?>img/bg-img/g1.jpg" class="btn gallery-img">See More +</a>
        </div>
    </div>
    <!-- Single Gallery Item -->
    <div class="single-gallery-item">
        ...
        <div class="view-more-btn">
            <a href="<?php echo ASSETS; ?>img/bg-img/g2.jpg" class="btn gallery-img">See More +</a>
        </div>
    </div>
    <!-- Single Gallery Item -->
    <div class="single-gallery-item">
        ...
        <div class="view-more-btn">
            <a href="<?php echo ASSETS; ?>img/bg-img/g3.jpg" class="btn gallery-img">See More +</a>
        </div>
    </div>
    ...
    <div class="single-gallery-item">
        ...
        <div class="view-more-btn">
            <a href="<?php echo ASSETS; ?>img/bg-img/g4.jpg" class="btn gallery-img">See More +</a>
        </div>
    </div>
</div>
<!-- ***** Gallery Area End ***** -->
