...
<body>
	<!-- Preloader -->
	<!-- <div id="preloader">
		<div class="greeneye-load"></div>
	</div> -->
	<div id="preloader">
		<img src="assets/img/core-img/preloader.svg" class="centered" alt="">
	</div>
				...
				<div class="row h-100">
					<div class="col-12 h-100">
						<div class="h-100 d-md-flex justify-content-between align-items-center">
							<p>Welcome to <span>greenEye - Health</span> </p>
	...
	<section class="breadcumb-area bg-img gradient-background-overlay" style="background-image: url(assets/img/bg-img/breadcumb1.jpg);">
		<div class="container h-100">
			<div class="row h-100 align-items-center">
				<div class="col-12">
			...
			<div class="row align-items-center">
				<div class="col-12 col-lg-6">
					<div class="features-content">
						...
						<p>l is one of the largest multi-super specialty institutes located in Kota, an industrial a
							...
							Sudha hospital brings together an outstanding pool of doctors, and clinical researchers
							 ...
							 scoveries; and translating scientific advances more swiftly into new ways of diagnosi
							 e to provide accessible and affordable healthcare.</p>
						<a href="#" class="btn greeneye-btn mt-50">View the services <span>+</span></a>
					</div>
				</div>
				<div class="col-12 col-lg-6">
					<div class="features-thumbnail">
						<img src="assets/img/bg-img/about1.jpg" alt="">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-6 col-lg-3">
					<div class="greenEye-blocks">
						<div class="flipper">
							<div class="front" style="background-image: url(assets/img/core-img/flip1.jpg);">
								<div class="box">
									<h2>Aldin Powell</h2>
									<p>Neurologist</p>
								</div>
							...
							<div class="back">
								...
								<div class="author d-flex">
									<div class="image mr-3 align-self-center">
										<div class="img" style="background-image: url(assets/img/core-img/flip1.jpg);"></div>
									</div>
				...
				<div class="col-md-6 col-lg-3">
					<div class="greenEye-blocks">
						<div class="flipper">
							<div class="front" style="background-image: url(assets/img/core-img/flip3.jpg);">
								<div class="box">
									<h2>Aldin Powell</h2>
									<p>Pediatrician</p>
								</div>
							...
							<div class="back">
								...
								<div class="author d-flex">
									<div class="image mr-3 align-self-center">
										<div class="img" style="background-image: url(assets/img/core-img/flip3.jpg);"></div>
									</div>
	...
	<!-- ***** Video Area Start ***** -->
	<section class="greeneye-video-area section-padding-100 bg-overlay bg-img" style="background-image: url(assets/img/bg-img/video.jpg);">
		<div class="container">
			<div class="row align-items-center">
					...
					<div class="video-box bg-overlay-black">
						...
						<div class="play-btn">
							<a class="popup-video" href="http://www.youtube.com/watch?v=0O2aH4XLbto">
								...
								<!-- <img src="assets/img/core-img/play.png" alt=""> -->
							</a>
							<h6>A day at greeneye-Video</h6>
						</div>
					</div>
				</div>
				<div class="col-12 col-lg-4">
					<div class="video-content">
						...
						<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet
							dolore magna aliquam erat volutpat. Lorem ipsum dolor sit amet, consectetuer adipiscing eli. Lorem ipsum dolor
	...
	<!-- ***** Tabs Area Start ***** -->
	<!-- <section class="greeneye-tabs-area section-padding-100">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="greeneye-tabs-content">
						<ul class="nav nav-tabs" id="myTab" role="tablist">
							<li class="nav-item">
								<a class="nav-link" id="institution-tab" data-toggle="tab" href="#institution" role="tab" aria-controls="institution"
								 aria-selected="false">Institution</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" id="faq-tab" data-toggle="tab" href="#faq" role="tab" aria-controls="faq" aria-selected="false">FAQ</a>
							</li>
							<li class="nav-item">
								<a class="nav-link active" id="specialities-tab" data-toggle="tab" href="#specialities" role="tab"
								 aria-controls="specialities" aria-selected="true">Specialities</a>
							</li>
							<li class="nav-item">
							...
							<li class="nav-item">
								<a class="nav-link" id="emergencies-tab" data-toggle="tab" href="#emergencies" role="tab" aria-controls="emergencies"
								 aria-selected="false">Emergencies</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" id="scolarship-tab" data-toggle="tab" href="#scolarship" role="tab" aria-controls="scolarship"
								 aria-selected="false">Scolarship Programs</a>
							</li>
						</ul>

						<div class="tab-content" id="myTabContent">
							<div class="tab-pane fade" id="institution" role="tabpanel" aria-labelledby="institution-tab">
								<div class="greeneye-tab-content d-md-flex align-items-center">
									<!-- Medilife Tab Text  -->
	<!-- <div class="greeneye-tab-text">
										<h2>Take a look at this</h2>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut
											laoreet dolore magna aliquam erat volutpat. Lorem ipsum dolor sit amet, consectetuer adipiscing eli. Lorem
											ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet
											dolore magna aliquam erat volutpat. Lorem ipsum dolor sit amet, consectetuer adipiscing eli sed diam nonummy
											nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Lorem ipsum dolor sit amet,
											consectetuer adipiscing eli.</p>
									</div> -->
	<!-- Medilife Tab Img  -->
	<!-- <div class="greeneye-tab-img">
										<img src="assets/img/bg-img/about1.jpg" alt="">
									</div>
								</div>
							</div>
	...
	<!-- Medilife Tab Img  -->
	<!-- <div class="greeneye-tab-img">
										<img src="assets/img/bg-img/medical1.png" alt="">
									</div>
								</div>
							</div>
	...
	<!-- Medilife Tab Img  -->
	<!-- <div class="greeneye-tab-img">
										<img src="assets/img/bg-img/tab.jpg" alt="">
									</div>
								</div>
							</div>
						...
						<div class="footer-widget-area">
							...
							<div class="footer-contact-form">
								<form action="#" method="post">
									<input type="text" class="form-control border-top-0 border-right-0 border-left-0" name="footer-name" id="footer-name"
									 placeholder="Name" />
									<input type="email" class="form-control border-top-0 border-right-0 border-left-0" name="footer-email" id="footer-email"
									 placeholder="Email" />
									<textarea name="message" class="form-control border-top-0 border-right-0 border-left-0" id="footerMessage"
					...
					<div class="col-12 col-sm-6 col-xl-3">
						<div class="footer-widget-area">
							...
							<div class="footer-newsletter-area">
								...
								<p>
									Our aim is to bring healthcare of world class health
	...
	<!-- Counter Plugin js -->
	<script src="vendors/counterup/plugins.js"></script>
	<!-- Active js -->
