        ...
        <div class="row">
            <div class="col-md-6 col-lg-3">
                <div class="greenEye-blocks">
                    <div class="flipper">
                        <div class="front" style="background-image: url(<?php echo ASSETS; ?>img/core-img/flip1.jpg);">
                            <div class="box">
                                <h2>Aldin Powell</h2>
                                <p>Neurologist</p>
                            </div>
                        ...
                        <div class="back">
                            ...
                            <div class="author d-flex">
                                <div class="image mr-3 align-self-center">
                                    <div class="img" style="background-image: url(<?php echo ASSETS; ?>img/core-img/flip1.jpg);"></div>
                                </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="greenEye-blocks">
                    <div class="flipper">
                        <div class="front" style="background-image: url(<?php echo ASSETS; ?>img/core-img/flip3.jpg);">
                            <div class="box">
                                <h2>Aldin Powell</h2>
                                <p>Pediatrician</p>
                            </div>
                        ...
                        <div class="back">
                            ...
                            <div class="author d-flex">
                                <div class="image mr-3 align-self-center">
                                    <div class="img" style="background-image: url(<?php echo ASSETS; ?>img/core-img/flip3.jpg);"></div>
                                </div>
                ...
                <div class="video-box bg-overlay-black">
                    ...
                    <div class="play-btn">
                        <a class="popup-video" href="http://www.youtube.com/watch?v=0O2aH4XLbto">
                            ...
                            <!-- <img src="<?php echo ASSETS; ?>img/core-img/play.png" alt=""> -->
                        </a>
...
<!-- Medilife Tab Img  -->
<!-- <div class="greeneye-tab-img">
										<img src="<?php echo ASSETS; ?>img/bg-img/medical1.png" alt="">
									</div>
								</div>
							</div>
...
<!-- Medilife Tab Img  -->
<!-- <div class="greeneye-tab-img">
										<img src="<?php echo ASSETS; ?>img/bg-img/tab.jpg" alt="">
									</div>
								</div>
							</div>
