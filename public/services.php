...
<section class="breadcumb-area bg-img gradient-background-overlay" style="background-image: url(<?php echo ASSETS; ?><?php echo ASSETS; ?>img/bg-img/breadcumb2.jpg);">
...
<div class="medilife-services-area clearfix">
    ...
    <!-- Single Services Area -->
    <div class="singleServiceArea equalize bg-img" style="background-image: url(<?php echo ASSETS; ?>img/bg-img/about1.jpg);"></div>
