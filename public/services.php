...
<body>
	...
	<section class="breadcumb-area bg-img gradient-background-overlay" style="background-image: url(assets/assets/img/bg-img/breadcumb2.jpg);">
		<div class="container h-100">
			<div class="row h-100 align-items-center">
				<div class="col-12">
	...
	<div class="medilife-services-area clearfix">
		...
		<div class="singleServiceArea equalize d-flex">
			...
			<div class="singleServiceText">
				...
				<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet
					dolore magna aliquam erat volutpat. Lorem ipsum dolor sit amet, consectetuer adipiscing eli. Lorem ipsum dolor sit
		...
		<!-- Single Services Area -->
		<div class="singleServiceArea equalize bg-img" style="background-image: url(assets/img/bg-img/about1.jpg);"></div>
			...
			<div class="row align-items-center">
				...
				<div class="col-12 col-md-4">
					<div class="single-benefits-thumb">
						<img src="assets/img/bg-img/benefits.png" alt="">
					</div>
				</div>
				<div class="col-12 col-md-4">
