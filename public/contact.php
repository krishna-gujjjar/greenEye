...
<body>
	...
	<section class="breadcumb-area bg-img gradient-background-overlay" style="background-image: url(assets/img/bg-img/breadcumb3.jpg);">
		<div class="container h-100">
			<div class="row h-100 align-items-center">
				<div class="col-12">
			...
			<div class="row">
				...
				<div class="col-12 col-lg-4">
					<div class="content-sidebar">
						...
						<div class="greeneye-emergency-card bg-img bg-overlay" style="background-image: url(assets/img/bg-img/about1.jpg);">
...
<center><h1>OUR LOCATION</h1></center><br><br>
	<!-- Google Maps -->
	<!-- Google Maps -->
